...
class CampusWeatherViewController: UIViewController {
    ...
    func lehiCampusFetch() {
        DarkSkyController.fetchWeatherInfo(for: DarkSkyRoute.lehiCampus) { (result) in
            switch result {
    ...
    func lehiJobsFetch() {
        GithubJobsController.fetchJobs(for: GithubJobsRoute.lehi) { (result) in
            switch result {
    ...
    func dallasCampusFetch() {
        DarkSkyController.fetchWeatherInfo(for: DarkSkyRoute.dallasCampus) { (result) in
            switch result {
    ...
    func phoenixCampusFetch() {
        DarkSkyController.fetchWeatherInfo(for: DarkSkyRoute.phoenixCampus) { (result) in
            switch result {
